    ...
    while True:
        ...
        if highest_ratio_item:
            ...
            try:
                ...
                base.log(
                    f"{base.white}Auto Buy Card: {base.green}Sucess ✔️ {base.white}| {base.green}New balance: {base.white}{current_balance} | {base.green}Buy Card: {base.white}{buy_card_name} | {base.green}Level: {base.white}{buy_card_level}"
                )
            except:
